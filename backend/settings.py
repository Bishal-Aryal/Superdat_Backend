...
try:
    ...
    def config(key, default=None, cast=None):
        ...
        if cast and value is not None:
            if cast == bool:
                # Convert to string first, then check if it's a truthy value
...
SECRET_KEY = "django-insecure-x)5r2q$s9dd-v08b+0u&lu6&eh0rua&bt5k(hklz6&8as-36ev"
...
DATABASES = {
    "default": {
        ...
        "NAME": config("POSTGRES_DB", default="superdad"),
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Superdad Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Superdad",
    ...
    "welcome_sign": "Welcome to Superdad",

    # Copyright on the footer
    # "copyright": "Nature Nuts tours and travels Ltd",
    ...
    "custom_css": "css/admin_unread_counters.css",
    "custom_js": None,
